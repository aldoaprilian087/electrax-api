...
def mcp_endpoint():
    server_info = {
        "name": "Electrax Agent Server",
        "version": "1.0.0",
        "website": "https://electrax-api.vercel.app",
...
def a2a_endpoint():
    return jsonify({
        ...
        "active": True,
        "x402support": True,
        "image": "https://blob.8004scan.app/06d333f1d21489de88905d480047f08f070d06ce5b26e1aff111b08028345730.jpg", 
        "tags": [
            "AI",
            "autonomous",
            "superfluid",
        ...
        "version": "1.0.0",
        "description": "Electrax is a smart AI agent for easy data analysis. It helps you understand datasets, make charts, and forecast trends fast on the Base network",
        "services": [
            {
                "name": "MCP",
                "version": "2025-06-18",
                "endpoint": "https://electrax-api.vercel.app/mcp",
                "transport": "http"
            },
            {
                "name": "A2A",
                "version": "0.3.0",
                "endpoint": "https://electrax-api.vercel.app/.well-known/agent-card.json",
                "transport": "http"
            }
        ],
        "registrations": [
...
def oasf_endpoint():
    return jsonify({
        ...
        "name": "electrax",
        "version": "v0.8.0",
        "description": "Main endpoint for Electrax AI analytics",
        "website": "https://electrax-api.vercel.app",
        "protocols": ["mcp","a2a"],
